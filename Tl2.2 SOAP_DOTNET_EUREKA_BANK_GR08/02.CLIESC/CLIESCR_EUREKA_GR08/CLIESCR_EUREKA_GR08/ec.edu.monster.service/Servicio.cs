...
using CLIESCR_EUREKA_GR08.WSCuentaReference;
using CLIESCR_EUREKA_GR08.WSLoginReference;
using CLIESCR_EUREKA_GR08.WSMovimientosReference;
using CLIESCR_EUREKA_GR08.ec.edu.monster.model;
namespace CLIESCR_EUREKA_GR08.ec.edu.monster.service
{
    internal class Servicio
    {
        ...
        {
            using (var movimientoClient = new WSMovimientosReference.MovimientoServicioClient())
            {
                try
                {
                    WSMovimientosReference.MovimientoModel[] movements = movimientoClient.Movimientos(accountNumber);
