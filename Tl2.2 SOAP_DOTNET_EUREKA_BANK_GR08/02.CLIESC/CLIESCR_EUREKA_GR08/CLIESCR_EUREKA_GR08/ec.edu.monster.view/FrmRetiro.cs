...
namespace CLIESCR_EUREKA_GR08.ec.edu.monster.view
{
    public partial class FrmRetiro : Form
    {
        ...
        {
            InitializeComponent();
            new RetiroController(this); // engancha el controlador
        }
        ...
        {
            OcultarMensaje();
            RetirarClicked?.Invoke(this, EventArgs.Empty);
        }

        private void btnVolver_Click(object sender, EventArgs e)
        {
            VolverMenuClicked?.Invoke(this, EventArgs.Empty);
            // aquí puedes hacer this.Close() si quieres
        }
        ...
        private void btnRetirar_Paint(object sender, PaintEventArgs e)
        {
