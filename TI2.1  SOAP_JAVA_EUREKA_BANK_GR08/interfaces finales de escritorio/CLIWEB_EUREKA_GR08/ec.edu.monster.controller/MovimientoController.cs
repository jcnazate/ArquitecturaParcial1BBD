...
using CLIWEB_EUREKA_GR08.MovimientoServicio;
    ...
    public class MovimientoController : Controller
    {
        ...
        public ActionResult Index(string cuenta)
        {
            ...
            try
            {
                ...
                {
                    // Obtener movimientos
                    List<MovimientoModel> movimientos = movimientoClient.Movimientos(cuenta.Trim())?.ToList() ?? new List<MovimientoModel>();

                    // Obtener datos de la cuenta
                    CuentaModel cuentaModel = cuentaClient.ObtenerCuentaPorNumero(cuenta.Trim());
