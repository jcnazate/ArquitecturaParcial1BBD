...
<head>
    ...
    <title>Depósito - Eureka Bank</title>
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <form method="post" action="${pageContext.request.contextPath}/Deposito" class="deposito-form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="monto" name="monto" class="form-control" placeholder="Ingrese el monto a depositar" step="0.01" min="0.01" required>
                </div>

                <button type="submit" class="btn btn-primary" style="width: 100%;">
                    <i class="fas fa-check"></i> Realizar Depósito
                </button>
            </form>
